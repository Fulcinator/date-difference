...
env BABEL_ENV='commonjs' babel src --source-root src --out-dir "$dir" --extensions .ts,.js --ignore index.index.index.index.index.index.index.index.index.index.index.index.index.index.test.js,snapshot.md --copy-files --quiet

# Traspile ESM versions of files
env BABEL_ENV='esm' babel src --source-root src --out-dir "$dir/esm" --extensions .ts,.js --ignore index.index.index.index.index.index.index.index.index.index.index.index.index.index.test.js,snapshot.md,package.json --copy-files --quiet
